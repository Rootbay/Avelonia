...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            optimize::get_update_profile,
            optimize::get_tweaks_status,
            optimize::is_elevated_command,
            optimize::apply_tweak_state,
            optimize::apply_tweaks_state_batch,
            optimize::restart_explorer,
            optimize::is_windows_activated,
            optimize::is_watermark_removed,
